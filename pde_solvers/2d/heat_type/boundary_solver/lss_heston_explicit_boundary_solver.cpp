#include "lss_heston_explicit_boundary_solver.hpp"
...
void explicit_heston_boundary_scheme::rhs(heston_implicit_coefficients_ptr const &cfg,
                                          grid_config_2d_ptr const &grid_cfg, std::size_t const &y_index,
                                          double const &y, boundary_2d_pair const &horizontal_boundary_pair,
...
void explicit_heston_boundary_scheme::rhs_source(heston_implicit_coefficients_ptr const &cfg,
                                                 grid_config_2d_ptr const &grid_cfg, std::size_t const &y_index,
                                                 double const &y, boundary_2d_pair const &horizontal_boundary_pair,
...
heston_explicit_boundary_solver::heston_explicit_boundary_solver(heston_implicit_coefficients_ptr const &coefficients,
                                                                 grid_config_2d_ptr const &grid_config)
    : coefficients_{coefficients}, grid_cfg_{grid_config}
{
}

heston_explicit_boundary_solver::~heston_explicit_boundary_solver()
{
}

void heston_explicit_boundary_solver::solve(container_2d<by_enum::Row> const &prev_solution,
                                            boundary_2d_pair const &horizonatal_boundary_pair,
...
void heston_explicit_boundary_solver::solve(container_2d<by_enum::Row> const &prev_solution,
                                            boundary_2d_pair const &horizonatal_boundary_pair, double const &time,
                                            container_2d<by_enum::Row> &solution)
{
    // 1D container for intermediate solution:
