#if !defined(_LSS_WAVE_EULER_SCHEME_HPP_)
#define _LSS_WAVE_EULER_SCHEME_HPP_
...
#include "../solver_method/lss_wave_euler_solver_method.hpp"
...
class wave_euler_scheme
{
  ...
  private:
    ...
    explicit wave_euler_scheme() = delete;

  public:
    wave_euler_scheme(wave_explicit_coefficients_ptr const &coefficients, boundary_1d_pair const &boundary_pair,
...
#endif ///_LSS_WAVE_EULER_SCHEME_HPP_
