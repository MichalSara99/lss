                                    ...
                                    double const &time, container_t &solution)
{
    ...
    thrust::device_vector<double> d_input_0(input_0);
    thrust::device_vector<double> d_input_1(input_1);
    thrust::device_vector<double> d_solution(solution);
                                           ...
                                           container_t &solution)
{
    ...
    thrust::device_vector<double> d_input_0(input_0);
    thrust::device_vector<double> d_input_1(input_1);
    thrust::device_vector<double> d_source(inhom_input);
    thrust::device_vector<double> d_solution(solution);
