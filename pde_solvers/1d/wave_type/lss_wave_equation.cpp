...
void wave_equation::solve(container_t &solution)
{
    ...
    container_t prev_sol_0(space_size, double{});
    ...
    container_t prev_sol_1(space_size, double{});
    ...
    container_t next_sol(space_size, double{});
    // get heat_source:
...
void wave_equation::solve(container_2d<by_enum::Row> &solutions)
{
