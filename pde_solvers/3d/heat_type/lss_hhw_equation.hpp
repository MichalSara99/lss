...
using d_3d = discretization_3d<std::vector, std::allocator<double>>;
...
/*!
============================================================================
Represents general variable coefficient Heston-Hull-White type equation
...
class hhw_equation
{
  ...
  public:
     ...
     */
    LSS_API void solve(container_3d<by_enum::RowPlane> &solution);
