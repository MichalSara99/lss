...
#include "splitting_method/lss_heat_douglas_rachford_method_3d.hpp"
...
#include "time_loop/lss_hhw_implicit_time_loop.hpp"
...
void hhw_equation_implicit_kernel<memory_space_enum::Device, tridiagonal_method_enum::CUDASolver>::operator()(
    container_3d<by_enum::RowPlane> &prev_solution, container_3d<by_enum::RowPlane> &next_solution,
    bool is_heat_sourse_set, std::function<double(double, double, double, double)> const &heat_source)
{
    // get time range:
    ...
    {
        hhw_implicit_time_loop::run(splitting_ptr, boundary_solver, boundary_pair_x_, boundary_y_, boundary_pair_z_,
