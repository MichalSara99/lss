...
const triplet_t sor_cuda_boundary::init_coefficients(boundary_2d_pair const &boundary, double time, double space_args)
{
...
const triplet_t sor_cuda_boundary::final_coefficients(boundary_2d_pair const &boundary, double time, double space_args)
{
...
void sor_cuda_boundary::initialise(boundary_2d_pair const &boundary, double time, double space_args)
{
    const auto a_0 = std::get<0>(lowest_quad_);
    const auto b_0 = std::get<1>(lowest_quad_);
    const auto c_0 = std::get<2>(lowest_quad_);
...
void sor_cuda_boundary::finalise(boundary_2d_pair const &boundary, double time, double space_args)
{
    const auto a = std::get<0>(higher_quad_);
    const auto b = std::get<1>(higher_quad_);
    const auto c = std::get<2>(higher_quad_);
...
const double sor_cuda_boundary::upper_boundary(boundary_2d_pair const &boundary, double time, double space_args)
{
    double ret{};
...
const double sor_cuda_boundary::lower_boundary(boundary_2d_pair const &boundary, double time, double space_args)
{
    double ret{};
