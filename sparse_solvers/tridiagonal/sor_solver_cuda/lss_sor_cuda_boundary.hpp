#pragma once
#if !defined(_LSS_SOR_CUDA_BOUNDARY_HPP_)
#define _LSS_SOR_CUDA_BOUNDARY_HPP_
...
class sor_cuda_boundary
{
  private:
    ...
    explicit sor_cuda_boundary() = delete;
  ...
  public:
    explicit sor_cuda_boundary(const std::size_t discretization_size, const double &space_step);
...
using sor_cuda_boundary_ptr = sptr_t<sor_cuda_boundary>;
} // namespace lss_sor_solver_cuda

#endif ///_LSS_SOR_CUDA_BOUNDARY_HPP_
