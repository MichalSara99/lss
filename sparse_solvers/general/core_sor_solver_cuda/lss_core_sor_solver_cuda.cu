...
void core_sor_solver_cuda::kernel(container_t &solution)
{
    ...
    thrust::device_vector<double> rhs_values = b_;
    ...
    thrust::device_vector<double> sol(solution.begin(), solution.end());
    thrust::device_vector<double> new_sol(solution.begin(), solution.end());
    thrust::device_vector<double> errors(solution.begin(), solution.end());
